    ...
    <div className="w-full xl:w-10/12 p-3 sm:p-5 mx-auto min-h-[80vh]">
      {props.cartProducts.length ? (
        <main className="flex flex-col md:flex-row md:items-start">
          ...
          <section className="w-full md:w-[40%] md:ml-2 mt-4 md:mt-0 border rounded-md p-3">
            ...
            <button
              type="button"
              className="mt-6 px-4 py-2 w-[40%] rounded-md bg-red-500 text-white hover:bg-red-700 transition-all text-sm"
            >
